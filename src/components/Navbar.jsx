...
const Navbar = () => {
  return (
    <nav className="w-full fixed top-0 left-0 z-50 bg-black bg-opacity-90 text-white shadow-lg">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-4 flex flex-wrap justify-between items-center">
        {/* Logo & Title */}
        ...
        {/* Always Visible Menu (Responsive) */}
        <ul className="flex flex-wrap justify-center gap-3 sm:gap-5 mt-4 sm:mt-0 font-medium w-full sm:w-auto text-sm sm:text-base">
